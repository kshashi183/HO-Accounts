...
import logo from "./MagodLogo.png";
...
export default function UnitDetails() {
  ...
  // Convert the image on component mount
  // useEffect(() => {
  ...
  const handleFileInputChange = (e) => {
    ...
    // console.log("type of selecetd file", typeof file.name, file);
  ...
  const handleSaveLogo = () => {
    axios
      .put(baseURL + "/unitlist/logo", { base64String: imageString })
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="row">
        <div
          className="col-md-4 mt-2 col-sm-12"
          style={{
            height: "380px",
            overflowX: "scroll",
            overflowY: "scroll",
                  ...
                  <>
                    ...
                    >
                      ...
                      <td>
                        {/* {item.Logo && (
                          <img
                            src={convertBase64ToImage(item.Logo)}
                            alt={`Logo of unit ${item.ID}`}
        ...
        <div className="col-md-8 ">
          <div className="row col-md-12" style={{ padding: "0px" }}>
            ...
            <div className="d-flex">
              <label htmlFor="imageUpload">Select Logo:</label>
              <input
                type="file"
                id="imageUpload"
                accept="image/*"
          ...
          <div className="row col-md-12 mt-1" style={{ padding: "0px" }}>
            ...
            <div className=" d-flex col-md-6 mt-1">
              ...
              <input
                className="mt-3 col-md-3 ms-5  custom-checkbox"
                type="checkbox"
                name="Current"
                id="flexCheckDefault"
                checked={
