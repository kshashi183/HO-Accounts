  ...
  return (
    <div>
      ...
      <div className="row col-md-12  ">
        ...
        <label className="form-label col-md-4 mt-2">Magod Laser :Tally Account List</label>
...
<Table striped className="table-data border">
    <thead className="tableHeaderBGColor">
        <tr>
            ...
            <th style={{ whiteSpace: 'nowrap' }}>Tally Account Name</th>
            <th style={{ whiteSpace: 'nowrap' }}>GUID</th>
