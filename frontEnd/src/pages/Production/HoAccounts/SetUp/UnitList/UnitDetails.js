...
export default function UnitDetails() {
  ...
  if (postData.UnitID === '' || postData.Name === '') {
    ...
    else if (!validatePIN(postData.PIN)) {
      toast.warn("Invalid PIN code")
      // console.log("err in PIN", validatePIN(postData.PIN));
      ...
      // console.log("err in gst no", validateGstNumber(postData.Unit_GSTNo));
      // setErrors((prevErrors) => ({
      //   ...prevErrors,
      ...
      toast.warn("Unit_Intial Length mustt be less than 3")
    }

    else {
      //  const updatedData = { ...postData, State: postState.State };
