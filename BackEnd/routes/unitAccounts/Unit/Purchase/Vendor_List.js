...
vendorList.post("/postInvoice", (req, res) => {
   ...
   console.log("req body", req.body.UnitName, req.body.Vendor_Code);
    

   

    // const sql = `INSERT INTO magod_hq_mis.unit_vendor_list
    //     (UnitName, Vendor_Code, Vendor_name, Address, City, State, Country, Pin_Code,   CreditLimit, CreditTime, VendorType, CURRENT, VendorStatus, Registration_Date,Unit_Id,Unit_ModId,HO_ModId,GSTNo,StateId)
    //     VALUES
    //     ('${UnitName}', '${req.body.Vendor_Code}', '${req.body.Vendor_name}', '${req.body.Address}','${req.body.City}', '${req.body.State}', '${req.body.Country}', '${req.body.Pin_Code}', '${req.body.CreditLimit}', '${req.body.CreditTime}', '${req.body.VendorType}', '${req.body.CURRENT}', '${req.body.VendorStatus}',  '${req.body.Registration_Date}','${Unit_Id}', '${Unit_ModId}', '${HO_ModId}', '${GSTNo}', '${StateId}'  )
    //     `

    let flag=0;
    const q=`SELECT UnitName , Vendor_Code FROM  magod_hq_mis.unit_vendor_list`;
    ...
    misQuery(q, (err, results)=>{
       // console.log("hi", results);
        for (let i = 0; i < results.length; i++) {
            ...
            if (results[i].UnitName === req.body.UnitName  && results[i].Vendor_Code === req.body.Vendor_Code ) {
                 console.log("database", results[i].Vendor_Code, results[i].UnitName);
                 console.log("req body", req.body.Vendor_Code, req.body.UnitName);
...
// vendorList.put('/updateInvoice', (req,res)=>{
